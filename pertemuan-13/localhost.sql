...
(1, 'Muhammad Alkautsar Dirgantara', '2511500039@mahasiswa.atmaluhur.ac.id', 'Mantap cees, terus lah terbang setinggi mungkin, walaupun jatuh setidaknya di awan'),
(2, 'Muhammad Alkautsar Dirgantara', '2511500039@mahasiswa.atmahluhur.ac.id', 'Semangat');
